...
}define("Agile/Contracts",["require","exports"],(function(t,e){e.Constants={},e.Constants.Unparented=0}),["Constants"]),document.dispatchEvent(new CustomEvent("scriptLoaded",{cancelable:!1,detail:{id:"ms.vss-work-web.agile-contracts"}}));