...
def test_grab_image_s3(
    mocker, input_file_path, input_bucket, mock_image_format, mock_image_stream
):
    # Mocking boto3 Session
    mock_session = mocker.patch.object(boto3, "Session")
    mock_s3_client = mock_session.return_value.client.return_value
...
def test_save_image_s3(
    mocker, input_image_format, input_file_path, input_bucket, expected_exception
):
    # Mocking boto3 Session
    mock_session = mocker.patch.object(boto3, "Session")
    mock_s3_client = mock_session.return_value.client.return_value
